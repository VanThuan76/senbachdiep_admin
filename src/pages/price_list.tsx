...
const PriceList = () => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>{trans.common.menu.price_list}</title>
        <meta name='description' content={trans.common.menu.price_list} />
        <meta name='keywords' content={trans.common.menu.price_list} />
...
PriceList.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
